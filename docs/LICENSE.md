...
3. Independent Works are considered non-canon, until the Independent Work's Content are submitted into the Project

4. Any Independent Works set in the Constructed World must include the notice stated in Section 3.1 on its copyright page or store listing.
...
1. All aspect of The Project are PROVIDED "AS IS", without warranty or condition of any kind. The authors shall not be liable for any claims or damages related to This Project.

2. The Project reserves the right to UPDATE THIS LICENSE for future Project releases. Updates will not retroactively revoke commercial rights for existing, properly published works that complied with previous versions.

3. Nothing in this agreement creates an employment, partnership, or legal agency relationship between The Project and community creators.
