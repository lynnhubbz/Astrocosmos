...
- see [how we use git, here](./git_specification/README.md), especially to [version](./git_specification/versioning.md) and changelog the [project](./git_specification/changelogging.md)