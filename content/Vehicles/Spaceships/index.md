...
This payload compartments are much more and much complicated than the next two, therefore this will be described in detail after them.
...
## Spaceship Main Classification

The Astrocosmos Space Authority use two category to classify spaceships. 
The first classification is based on their compartments and capacities, the second one is based on their roles. 
This classification was made because size can varies between faction or even species, but even so, an observer or lookout posts will try to identify ships based on the observed size range.
...
SpaceCRAFTs are space vehicles that do not have ground-contact as its primary movement component and have cockpits as its control deck. 
...
Meanwhile, SpaceSHIPs are space vehicles that do not have ground-contact as its primary movement component, and have command bridge/deck as its control deck.
...
![[ship_classification.md|See here for the classification]]
